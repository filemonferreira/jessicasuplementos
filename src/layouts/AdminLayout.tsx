            ...
            <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
                <div>
                    <div className="-mx-6 px-6 py-4 ">
                        <a href="#" title="home">
                            <img src="src/assets/logo.png" className="w-32" alt="tailus logo" />
                        </a>
                    </div>

                    <div className="mt-8 text-center">
                        <img src="https://github.com/filemonferreira.png" alt="" className="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28" />
                    ...
                    <ul className="space-y-2 tracking-wide mt-8">
                        ...
                        <li>
                            <Link to="/admin/my-orders" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                                <FiGift size={24} />
